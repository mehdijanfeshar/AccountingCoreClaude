...
public sealed class UpdateAccountExceptionCommandHandlerTests
{
    private static UpdateAccountExceptionCommand ValidCommand(Guid id) => new(
        Id: id,
    ...
    public async Task Handle_ExistingNonDeletedRecord_WritesAllWritableFieldsFromCommand()
    {
        ...
        var handler = new UpdateAccountExceptionCommandHandler(repository.Object, unitOfWork.Object, currentUser.Object);
        var command = ValidCommand(id);

        await handler.Handle(command, CancellationToken.None);

        Assert.Equal(command.AccountCoeId, entity.ACCOUNTCOE_ID);
