...
public sealed class GetReceiptsQueryHandlerTests
{
    ...
    public async Task Handle_PassesPageNumberAndPageSizeToRepository_AndReturnsRepositoryResult()
    {
        ...
        var query = new GetReceiptsQuery(PageNumber: 2, PageSize: 25) { VahedCode = "0001" };
    ...
    public async Task Handle_PassesRequestVahedCodeToRepository_AtFaceValue()
    {
        ...
        var handler = new GetReceiptsQueryHandler(readRepository.Object);
        var query = new GetReceiptsQuery(PageNumber: 1, PageSize: 20) { VahedCode = "0007" };
    ...
    public async Task Handle_PropagatesCancellationTokenToRepository()
    {
        ...
        var handler = new GetReceiptsQueryHandler(readRepository.Object);
        var query = new GetReceiptsQuery(PageNumber: 1, PageSize: 20) { VahedCode = "0001" };
