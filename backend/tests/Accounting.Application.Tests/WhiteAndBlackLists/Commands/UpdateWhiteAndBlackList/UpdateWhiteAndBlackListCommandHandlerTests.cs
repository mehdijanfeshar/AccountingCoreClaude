...
public sealed class UpdateWhiteAndBlackListCommandHandlerTests
{
    private static UpdateWhiteAndBlackListCommand ValidCommand(Guid id) => new(
        Id: id,
    ...
    public async Task Handle_ExistingNonDeletedRecord_WritesAllWritableFieldsFromCommand()
    {
        ...
        var handler = new UpdateWhiteAndBlackListCommandHandler(repository.Object, unitOfWork.Object, currentUser.Object);
        ...
        Assert.Equal(command.State, entity.STATE);
    }
