...
public sealed class GetElamHeadsQueryHandlerTests
{
    ...
    public async Task Handle_PassesPageNumberAndPageSizeToRepository_AndReturnsRepositoryResult()
    {
        ...
        var query = new GetElamHeadsQuery(PageNumber: 2, PageSize: 25) { VahedCode = "0001" };
    ...
    public async Task Handle_PassesRequestVahedCodeToRepository_AtFaceValue()
    {
        ...
        var handler = new GetElamHeadsQueryHandler(readRepository.Object);
        var query = new GetElamHeadsQuery(PageNumber: 1, PageSize: 20) { VahedCode = "0007" };
    ...
    public async Task Handle_PropagatesCancellationTokenToRepository()
    {
        ...
        var handler = new GetElamHeadsQueryHandler(readRepository.Object);
        var query = new GetElamHeadsQuery(PageNumber: 1, PageSize: 20) { VahedCode = "0001" };
