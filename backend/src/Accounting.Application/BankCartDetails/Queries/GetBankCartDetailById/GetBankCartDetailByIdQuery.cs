...
/// <summary>
/// Returns a single <c>TB_BANKCARTDETAIL</c> row projected to <see cref="BankCartDetailDto"/>, or
...
/// <c>ISDELETED</c>, and <see cref="BankCartDetailDto.IsDeleted"/> lets the caller decide.
/// </summary>
/// <param name="Id">ID column to look up.</param>
public sealed record GetBankCartDetailByIdQuery(Guid Id) : IRequest<BankCartDetailDto?>, IVahedScopedQuery
{
    /// <summary>
