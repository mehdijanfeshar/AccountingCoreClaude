...
/// </summary>
public sealed class GetBankCartDetailsQueryValidator : AbstractValidator<GetBankCartDetailsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetBankCartDetailsQuery.PageNumber"/>. Chosen as
    ...
    public GetBankCartDetailsQueryValidator()
    {
