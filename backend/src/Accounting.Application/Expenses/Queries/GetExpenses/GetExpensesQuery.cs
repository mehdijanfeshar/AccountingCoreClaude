...
/// <c>ExpenseReadRepository.GetPagedAsync</c> for why the filter is unconditional).
/// </summary>
/// <param name="PageNumber">1-based page number.</param>
/// <param name="PageSize">Page size, capped by <see cref="GetExpensesQueryValidator.MaxPageSize"/>.</param>
public sealed record GetExpensesQuery(int PageNumber, int PageSize)
    : IRequest<PagedResult<ExpenseDto>>, IVahedScopedQuery
{
    /// <summary>
