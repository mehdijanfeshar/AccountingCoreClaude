...
/// </summary>
public sealed class GetRevolvingFundsQueryValidator : AbstractValidator<GetRevolvingFundsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetRevolvingFundsQuery.PageNumber"/>. Chosen as
    ...
    public GetRevolvingFundsQueryValidator()
    {
