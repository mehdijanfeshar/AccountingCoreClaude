...
/// <c>RevolvingFundReadRepository.GetPagedAsync</c> for why the filter is unconditional).
/// </summary>
/// <param name="PageNumber">1-based page number.</param>
/// <param name="PageSize">Page size, capped by <see cref="GetRevolvingFundsQueryValidator.MaxPageSize"/>.</param>
public sealed record GetRevolvingFundsQuery(int PageNumber, int PageSize)
    : IRequest<PagedResult<RevolvingFundDto>>, IVahedScopedQuery
{
    /// <summary>
