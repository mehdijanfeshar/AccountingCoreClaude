...
/// </summary>
public sealed class GetTafsilGroupsQueryValidator : AbstractValidator<GetTafsilGroupsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetTafsilGroupsQuery.PageNumber"/>. Chosen as
    ...
    public GetTafsilGroupsQueryValidator()
    {
