...
/// </summary>
public sealed class GetChequeTypesQueryValidator : AbstractValidator<GetChequeTypesQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetChequeTypesQuery.PageNumber"/>. Chosen as
    ...
    public GetChequeTypesQueryValidator()
    {
