...
/// </summary>
public sealed class GetElamHeadsQueryValidator : AbstractValidator<GetElamHeadsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetElamHeadsQuery.PageNumber"/>. Chosen as
    ...
    public GetElamHeadsQueryValidator()
    {
