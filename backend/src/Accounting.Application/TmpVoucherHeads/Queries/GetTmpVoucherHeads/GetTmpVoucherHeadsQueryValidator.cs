...
/// </summary>
public sealed class GetTmpVoucherHeadsQueryValidator : AbstractValidator<GetTmpVoucherHeadsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetTmpVoucherHeadsQuery.PageNumber"/>. Chosen as
    ...
    public GetTmpVoucherHeadsQueryValidator()
    {
