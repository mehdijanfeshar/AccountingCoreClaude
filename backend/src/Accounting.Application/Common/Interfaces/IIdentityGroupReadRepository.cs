...
{
    /// <summary>
    /// Returns a page of non-deleted identity-group rows belonging to <paramref name="vahedCode"/>,
    ...
    /// </summary>
    Task<IdentityGroupDto?> GetByIdAsync(Guid id, string vahedCode, CancellationToken cancellationToken = default);
}
