...
/// </summary>
public sealed class GetLevelTafsilsQueryValidator : AbstractValidator<GetLevelTafsilsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetLevelTafsilsQuery.PageNumber"/>. Chosen as
    ...
    public GetLevelTafsilsQueryValidator()
    {
