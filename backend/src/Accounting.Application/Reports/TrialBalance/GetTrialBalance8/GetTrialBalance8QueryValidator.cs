...
/// </summary>
public sealed class GetTrialBalance8QueryValidator : AbstractValidator<GetTrialBalance8Query>
{
    public GetTrialBalance8QueryValidator()
    {
        ...
        RuleFor(x => x)
            ...
            .WithName(nameof(GetTrialBalance8Query.FromDate));
