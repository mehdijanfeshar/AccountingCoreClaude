...
/// <c>WorkShopReadRepository.GetPagedAsync</c> for why the filter is unconditional).
/// </summary>
/// <param name="PageNumber">1-based page number.</param>
/// <param name="PageSize">Page size, capped by <see cref="GetWorkShopsQueryValidator.MaxPageSize"/>.</param>
public sealed record GetWorkShopsQuery(int PageNumber, int PageSize)
    : IRequest<PagedResult<WorkShopDto>>, IVahedScopedQuery
{
    /// <summary>
