...
/// <see cref="IWorkShopRepository.GetForUpdateAsync"/> and soft-deletes it. Throws
...
/// </summary>
public sealed class DeleteWorkShopCommandHandler : IRequestHandler<DeleteWorkShopCommand>
{
