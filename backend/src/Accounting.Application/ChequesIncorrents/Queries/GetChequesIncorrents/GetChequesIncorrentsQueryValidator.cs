...
/// </summary>
public sealed class GetChequesIncorrentsQueryValidator : AbstractValidator<GetChequesIncorrentsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetChequesIncorrentsQuery.PageNumber"/>. Chosen as
    ...
    public GetChequesIncorrentsQueryValidator()
    {
