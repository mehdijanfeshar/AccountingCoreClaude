...
/// re-created here.
/// </summary>
public sealed class UpdateWhiteAndBlackListCommandValidator : AbstractValidator<UpdateWhiteAndBlackListCommand>
{
    public UpdateWhiteAndBlackListCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty();
