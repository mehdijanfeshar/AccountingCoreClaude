...
/// </summary>
public sealed class GetPreDescribsQueryValidator : AbstractValidator<GetPreDescribsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetPreDescribsQuery.PageNumber"/>. Chosen as
    ...
    public GetPreDescribsQueryValidator()
    {
