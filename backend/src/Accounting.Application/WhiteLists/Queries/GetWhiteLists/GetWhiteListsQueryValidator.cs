...
/// </summary>
public sealed class GetWhiteListsQueryValidator : AbstractValidator<GetWhiteListsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetWhiteListsQuery.PageNumber"/>. Chosen as
    ...
    public GetWhiteListsQueryValidator()
    {
