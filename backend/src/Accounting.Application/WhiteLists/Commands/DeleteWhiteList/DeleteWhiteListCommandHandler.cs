...
/// <see cref="IWhiteListRepository.GetForUpdateAsync"/> and soft-deletes it. Throws
...
/// </summary>
public sealed class DeleteWhiteListCommandHandler : IRequestHandler<DeleteWhiteListCommand>
{
    private readonly IWhiteListRepository _whiteListRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICurrentUser _currentUser;

    public DeleteWhiteListCommandHandler(
    ...
    public async Task Handle(DeleteWhiteListCommand request, CancellationToken cancellationToken)
    {
