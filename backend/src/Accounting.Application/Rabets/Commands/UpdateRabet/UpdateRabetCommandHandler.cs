...
/// <see cref="IRabetRepository.GetForUpdateAsync"/> (change-tracked), overwrites every writable
...
/// </summary>
public sealed class UpdateRabetCommandHandler : IRequestHandler<UpdateRabetCommand>
{
    private readonly IRabetRepository _rabetRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICurrentUser _currentUser;

    public UpdateRabetCommandHandler(
    ...
    public async Task Handle(UpdateRabetCommand request, CancellationToken cancellationToken)
    {
        ...
        entity.RABETTYPE_ID = request.RabetTypeId;
