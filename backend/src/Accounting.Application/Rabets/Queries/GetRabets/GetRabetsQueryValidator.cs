...
/// </summary>
public sealed class GetRabetsQueryValidator : AbstractValidator<GetRabetsQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetRabetsQuery.PageNumber"/>. Chosen as
    ...
    public GetRabetsQueryValidator()
    {
