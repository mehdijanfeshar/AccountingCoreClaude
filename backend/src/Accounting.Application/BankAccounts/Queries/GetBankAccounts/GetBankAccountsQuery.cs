...
/// <c>BankAccountReadRepository.GetPagedAsync</c> for why the filter is unconditional).
/// </summary>
/// <param name="PageNumber">1-based page number.</param>
/// <param name="PageSize">Page size, capped by <see cref="GetBankAccountsQueryValidator.MaxPageSize"/>.</param>
public sealed record GetBankAccountsQuery(int PageNumber, int PageSize)
    : IRequest<PagedResult<BankAccountDto>>, IVahedScopedQuery
{
    /// <summary>
