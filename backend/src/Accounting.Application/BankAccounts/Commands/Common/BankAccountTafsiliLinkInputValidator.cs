...
/// <c>TB_ACCOUNT_LINK_TAFSILI</c> in <c>LegacyDbContext</c>. Mirrors
...
/// تفصیلی is <i>permitted</i> for the account's معین (the
...
/// </summary>
public sealed class BankAccountTafsiliLinkInputValidator : AbstractValidator<BankAccountTafsiliLinkInput>
{
    public BankAccountTafsiliLinkInputValidator()
    {
