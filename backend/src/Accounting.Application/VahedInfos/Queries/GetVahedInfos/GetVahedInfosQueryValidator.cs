...
/// </summary>
public sealed class GetVahedInfosQueryValidator : AbstractValidator<GetVahedInfosQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetVahedInfosQuery.PageNumber"/>. Chosen as
    ...
    public GetVahedInfosQueryValidator()
    {
