...
/// non-deleted rows (<c>ISDELETED == false</c>) are included, and — via
...
/// <c>ReceiptReadRepository.GetPagedAsync</c> for why the filter is unconditional).
/// </summary>
/// <param name="PageNumber">1-based page number.</param>
/// <param name="PageSize">Page size, capped by <see cref="GetReceiptsQueryValidator.MaxPageSize"/>.</param>
public sealed record GetReceiptsQuery(int PageNumber, int PageSize)
    : IRequest<PagedResult<ReceiptDto>>, IVahedScopedQuery
{
    /// <summary>
