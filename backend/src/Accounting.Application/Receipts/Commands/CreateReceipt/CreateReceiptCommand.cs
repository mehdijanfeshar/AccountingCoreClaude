...
///
/// <c>ReceiptKind</c> — <see cref="ReceiptType"/> (1=Fish/فیش, 2=Havale/حواله). Resolved from the
...
/// </summary>
/// <param name="ReceiptKind">RECEIPT_KIND column — see the resolved-enum note above.</param>
