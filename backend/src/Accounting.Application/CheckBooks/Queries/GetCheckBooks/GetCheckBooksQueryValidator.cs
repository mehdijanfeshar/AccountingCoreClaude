...
/// </summary>
public sealed class GetCheckBooksQueryValidator : AbstractValidator<GetCheckBooksQuery>
{
    public const int MaxPageSize = 200;

    /// <summary>
    /// Upper bound for <see cref="GetCheckBooksQuery.PageNumber"/>. Chosen as
    ...
    public GetCheckBooksQueryValidator()
    {
