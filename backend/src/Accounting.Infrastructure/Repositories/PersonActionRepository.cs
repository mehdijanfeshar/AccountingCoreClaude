...
public sealed class PersonActionRepository : IPersonActionRepository
{
    ...
    public async Task<TB_PERSON_ACTION?> GetForUpdateAsync(
        Guid id,
        string vahedCode,
        CancellationToken cancellationToken = default)
    {
        var entity = await _dbContext.TB_PERSON_ACTIONs
        ...
        VahedOwnership.EnsureOwned(entity?.VAHEDCODE, vahedCode, id, "PersonAction");
