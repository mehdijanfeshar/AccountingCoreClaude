...
public sealed class BillLogRepository : IBillLogRepository
{
    ...
    public async Task<TB_BILL_LOG?> GetForUpdateAsync(
        Guid id,
        string vahedCode,
        CancellationToken cancellationToken = default)
    {
        var entity = await _dbContext.TB_BILL_LOGs
        ...
        VahedOwnership.EnsureOwned(entity?.VAHEDCODE, vahedCode, id, "BillLog");
