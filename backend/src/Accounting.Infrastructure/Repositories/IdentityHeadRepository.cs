...
public sealed class IdentityHeadRepository : IIdentityHeadRepository
{
    ...
    public async Task<TB_IDENTITYHEAD?> GetForUpdateAsync(
        Guid id,
        string vahedCode,
        CancellationToken cancellationToken = default)
    {
        var entity = await _dbContext.TB_IDENTITYHEADs
        ...
        VahedOwnership.EnsureOwned(entity?.VAHEDCODE, vahedCode, id, "IdentityHead");
