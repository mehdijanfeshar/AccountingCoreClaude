...
public partial class TB_REVOLVINGFUND_LINK_TAFSILI
{
    public string ID { get; set; } = null!;

    public string REVOLVINGFUND_ID { get; set; } = null!;
    ...
    public virtual TB_REVOLVING_FUND REVOLVINGFUND { get; set; } = null!;
